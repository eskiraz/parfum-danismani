...
# --- ADIM 1: "YAPAY ZEKA"NIN BEYNİ (v2.6) ---
# JSON VERİTABANI ÖNCE ESKİ HALİYLE (LOKAL YOLLARLA) YÜKLENECEK.
# BU, HATALARI ÖNLEMEK İÇİN BİLİNÇLİ BİR TERCİHTİR.
...
[
  ...
  },
  {
    ...
    "cinsiyet": "Kadın",
    "resim_yolu": "resimler/346.jpg",
    "kategori": "Amber, Fougère, Vanilya",
    "notalar": ["Lavanta", "Vanilya", "Orkide", "Tonka Fasulyesi", "Amber", "Vetiver"]
  }
]
"""
# --- ADIM 2: VERİTABANINI YÜKLEME VE RESİMLERİ GÜNCELLEME ---

# Sağladığınız tek, genel resmin URL'si
...
# Veritabanındaki TÜM resim yollarını tek bir URL ile GÜNCELLE
# Bu, f-string hatası veya cache sorunlarına karşı en garanti yoldur.
for parfum in veritabani:
    parfum['resim_yolu'] = GENEL_RESIM_URL

# --- ADIM 3: BENZERLİK MOTORUNU HAZIRLAMA ---
...
def benzerlik_motorunu_hazirla(db):
    # DİKKAT: db'yi (güncellenmiş resim yollarıyla) değil,
    # sadece notaları kullanıyoruz, bu yüzden cache'leme sorunu olmaz.
        ...
        if nota_terimi:
            ...
            if not sonuclar:
                ...
                for p in sonuclar:
                    ...
                    with col_img:
                        # DÜZELTME: Artık 'resim_yolu' doğrudan URL'yi içeriyor
